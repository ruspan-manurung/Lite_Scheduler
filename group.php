            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="group_management.php">
                            <div class="mb-3">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        // Fetching Group Management Data
                        $sql = "SELECT * FROM Group_Management";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo '<table class="table table-striped">';
                            echo '<thead><tr><th>Project ID</th><th>Category</th><th>User ID</th><th>Role ID</th><th>Task ID</th></tr></thead>';
                            echo '<tbody>';
