            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="task_management.php">
                            <div class="mb-3">
                                <input type="text" class="form-control" name="task_id" placeholder="Task ID" required>
                            </div>
                            <div class="mb-3">
                                <input type="date" class="form-control" name="task_end_date" placeholder="End Date" required>
                            </div>
                            <div class="mb-3">
                                <input type="date" class="form-control" name="task_start_date" placeholder="Start Date" required>
                            </div>
                            <div class="mb-3">
                                <textarea class="form-control" name="task_description" placeholder="Task Description" required></textarea>
                            </div>
                            <div class="mb-3">
                                <input type="text" class="form-control" name="role_id" placeholder="Role ID" required>
                            </div>
                            <div class="mb-3">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        // Fetching Task Management Data
                        $sql = "SELECT * FROM Task";
                        $result = $conn->query($sql);

                        if ($result->num_rows > 0) {
                            echo '<table class="table table-striped">';
                            echo '<thead><tr><th>Task ID</th><th>End Date</th><th>Start Date</th><th>Description</th><th>Role ID</th><th>Category</th></tr></thead>';
                            echo '<tbody>';
